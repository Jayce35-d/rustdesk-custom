...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(
            check_ws("zhangpengju.cyou:21115"),
            "ws://zhangpengju.cyou/ws/id"
        );
        assert_eq!(
            check_ws("zhangpengju.cyou:21116"),
            "ws://zhangpengju.cyou/ws/id"
        );
        assert_eq!(
            check_ws("zhangpengju.cyou:21117"),
            "ws://zhangpengju.cyou/ws/relay"
        );
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://zhangpengju.cyou".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(
            check_ws("zhangpengju.cyou:34567"),
            "wss://zhangpengju.cyou/ws/relay"
        );
